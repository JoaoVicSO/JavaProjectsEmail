...
public class ProfessorController {
	...
	@GetMapping("/listarEditarProfessor")
	public ModelAndView listarEditarProfessores() {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView listarExcluirProfessor() {
		ModelAndView mv = new ModelAndView();
		mv.setViewName("Professor/listarExcluirProfessor");
		mv.addObject("professores", professorRepository.findAllOrderedById());
		return mv;
	}
	...
	public String excluirProfessor(@PathVariable("id") Long id) {		
		...
		return "redirect:/listarExcluirProfessor";
	}
